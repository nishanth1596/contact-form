...
- Solution URL: [Solution URL](https://github.com/nishanth1596/contact-form)
- Live Site URL: [Live site URL](https://nishanth-contact-form.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/contact-form.git
   ```
...
Google Fonts - I used the Karla fonts from Google Fonts to style the text.
